            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                            ...
                            <div class="form-group">
                                <label for="username">Tamaño:</label><br>
                                <input type="text" name="tamaño" id="tamaño" class="form-control" value="<?php echo $usuario ['tamaño']; ?>">
                            </div>
                          ...
                          <input type="hidden" name="accion" value="editar_materiales">
                               ...
                               <a href="../views/materiales.php" class="btn btn-danger">Cancelar</a>
