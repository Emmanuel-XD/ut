...
function insertar_reporte(){
    ...
    $consulta="INSERT INTO reporte (control, nombre, fecha , cantidad, equipos)
    VALUES ('$control', '$nombre', '$fecha', '$cantidad', '$equipos');" ;
    $resultado=mysqli_query($conexion, $consulta);
...
function editar_reporte() {
    require_once ("db.php");
    extract($_POST);
    $consulta="UPDATE reporte SET control = '$control', nombre = '$nombre', fecha ='$fecha', 
    cantidad = '$cantidad', equipos = '$equipos'  WHERE id = '$id' ";
    $resultado=mysqli_query($conexion, $consulta);
