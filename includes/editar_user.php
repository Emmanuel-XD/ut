                ...
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                            ...
                            <div class="form-group">
                                  ...
                                  <option <?php echo $usuario ['rol_id']==='1' ? "selected='selected' ": "" ?> value="1">Administrador</option>
                                  <option <?php echo $usuario ['rol_id']==='2' ? "selected='selected' ": "" ?> value="2">Alumno</option>
