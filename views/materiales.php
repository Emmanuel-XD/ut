...
<div class="row">
    ...
    <br>
    <div>
    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#material">
				<span class="glyphicon glyphicon-plus"></span> Agregar material  <i class="fa fa-user-plus"></i> </a></button>
...
<td>
<a class="btn btn-warning" href="../includes/editar_mat.php?id=<?php echo $fila['id']?> ">
