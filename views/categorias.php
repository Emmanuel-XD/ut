...
<div class="row">
    ...
    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#categoria">
				<span class="glyphicon glyphicon-plus"></span> Agregar categorias  <i class="fa fa-user-plus"></i> </a></button>
...
<td>
<a class="btn btn-warning" href="../includes/editar_cat.php?id=<?php echo $fila['id']?> ">
