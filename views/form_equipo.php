        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header ">
                    <h3 class="modal-title" id="exampleModalLabel">Nuevo Equipo</h3>
                ...
                <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="fecha_ins" id="fecha_ins" class="form-control" required>
                            </div>
                            
                            <div class="form-group">
                                <label for="caducidad">Fecha Servicio:</label><br>
                                <input type="date" name="fecha_serv" id="fecha_serv" class="form-control" required>
